    ...
    def __call__(self, doc: Doc) -> Doc:
        ...
        for tok in doc:
            if not tok.is_space:
                ...
                if best_sim_score == 0 and len(analyses) > 0 and len(ud_analyses) > 0:
                    tok._.em_tag = analyses[0][1]
                    tok._.ud_tag = ud_analyses[0][0]
                    tok._.em_lemma = analyses[0][0]
                    tok._.ud_morph = MorphAnalysis(self._nlp.vocab, ud_analyses[0][1])
