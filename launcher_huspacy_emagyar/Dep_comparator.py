...
class Dep_comparator(Comparator):
    ...
    def compare(self):
        return super().compare(self.huspacy, self.emagyar, "összehasonlítás (dep. elemz.)\tösszehasonlítás (fej)\tHuSpaCy dep. elemz. (eredeti)\tHuSpaCy dep. elemz. (konvertált)\tHuSpaCy fej\te-magyar dep. elemz.\te-magyar fej")